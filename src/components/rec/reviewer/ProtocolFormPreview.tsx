...
const ProtocolReviewForm = dynamic(
  () => import('@/components/rec/reviewer/forms/protocol-review-assesment-form'),
  { loading: () => <p>Loading Protocol Form...</p> }
);
const InformedConsentForm = dynamic(
  () => import('@/components/rec/reviewer/forms/informed-consent-assesment-form'),
  { loading: () => <p>Loading Consent Form...</p> }
);
const ExemptionChecklistForm = dynamic(
  () => import('@/components/rec/reviewer/forms/exemption-checklist-form'),
  { loading: () => <p>Loading Exemption Form...</p> }
);
const IACUCForm = dynamic(
  () => import('@/components/rec/reviewer/forms/protcol-review-IACUC-form'),
